...
def load_dataset(data_path, train_test_ratio):
...
if __name__ == '__main__':
  x_train, x_test = load_dataset(data_path='SCUT-FBP5500_v2', train_test_ratio=6)
  hr_images = np.array(x_train)
  del x_train
  ...
  # build test
  test_hr_images = np.array(x_test)
